...
const SLIDES = [
  ...
  },
  {
    ...
    desc: 'Log in to unlock all personal features: save results, track progress, write a diary, and build your routine.',
    descKr: '로그인하고 모든 기능을 이용하세요: 결과 저장, 변화 추적, 피부 일지, 루틴 관리.',
    visual: [
